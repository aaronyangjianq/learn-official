  ...
  methods: {
    ...
    handleScroll() {
      ...
      if (top > 68) {
        ...
        this.$refs.head.style.borderBottom = "none";
        this.$refs.head.style.borderColor = "none";
        this.ischangeTabColor = true;
        this.$refs.head.style.opacity = "0.8";
      } else {
        this.$refs.head.style.position = "";
        this.$refs.head.style.borderBottom = "thin solid";
        this.$refs.head.style.borderColor = "rgba(192,192,192,0.2902)";
